...
setup({
  ...
  "result": {
    ...
    name="bankroll-broker-Charlesschwab",
    version="0.4.0",
    ...
    license="MIT",
    url="https://github.com/bankroll",
    packages=["bankroll.brokers.schwab"],
    package_data={"bankroll.brokers.schwab": ["py.typed"]},
    classifiers=[
